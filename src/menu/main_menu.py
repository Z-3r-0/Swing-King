...
OPTIONS = Button(screen, lambda: print("Button clicked"), (532,460), (270,80),
                 "../../assets/images/buttons/OPTIONS.png","../../assets/images/buttons/OPTIONS_HOVERED.png")
CREDITS = Button(screen, lambda: print("Button clicked"), (532,550), (270,80),
                 "../../assets/images/buttons/CREDITS.png","../../assets/images/buttons/CREDITS_HOVERED.png")
EXIT = Button(screen, lambda: exit_button(), (532,640), (270,80), "../../assets/images/buttons/EXIT.png")
